    ...
    <div class="container">
        ...
        <div class="row  ">
            <?php foreach ($books as $book) : ?>
                <div class="col-lg-3 col-md-4 col-sm-6 align-items-center p-3 bg-light border border-info rounded my-2  ">
                    
                    <div class="container">
                        <div class=" d-flex justify-content-center">
                            <img   height="200"   src="<?= $this->e($book->image) ?>" alt="Sach <?= $this->e($book->id) ?>">
                        </div>
                    </div>
